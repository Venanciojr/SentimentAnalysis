...
public enum ConsoleColour {
	...
	/**
	 * Constructor for ConsoleColour enum.
	 * 
	 * @param description The description of the colour
	 * @param colour      The code representation of the colour
	 */
	...
	/**
	 * Returns the description of the colour.
	 * 
	 * @return The description of the colour
	 */
	...
	/**
	 * Returns the code representation of the colour.
	 * 
	 * @return The code representation of the colour
	 */
	...
	/**
	 * Converts the ConsoleColour to its ANSI escape sequence representation.
	 * 
	 * @return The ANSI escape sequence for the ConsoleColour
	 */
